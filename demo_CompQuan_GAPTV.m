% Just run this code you will see the results of comaprison using measurements with and without quantization
...
save(['..\Temp_results\8img_CompQuan_CS_GAPTV_2D_DCTWHTsensing.mat'], '-v7.3','y_all', 'qy_all',...
    'im_rec','PSNR_all','SSIM_all','im_rec_qy','PSNR_all_qy','SSIM_all_qy');

saveas(h8, ['..\Temp_results\8img_CompQuan_CS_GAPTV_2DWHTDCT.fig']);
saveas(h8, ['..\Temp_results\8img_CompQuan_CS_GAPTV_2DWHTDCT.png']);
