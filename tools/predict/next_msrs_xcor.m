  ...
  for k=1:mcor.nStages()
    ...
    if opts.fxd_trgt
      if ~isempty(nghbr_ofsts)
        ...
        needed_ofsts = offsets;
      end
      
      ofst_msrs = get_ofst_msrs(needed_ofsts, vid_region, sens_mtrx, msrs, params);
