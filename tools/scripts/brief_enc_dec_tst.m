function sml_io = brief_enc_dec_tst()
...
enc_opts = struct('process_color',true, 'par_blks', 0, ...
...
%   struct('args', struct('b_stt', VidBlocker.BLK_STT_INTRPLT)));
% dec_opts = [];
dec_opts = struct('disp', 0, 'whole_frames', false);
...
proc_opts = struct('use_single', true, ...
  'report_blk', false, 'no_stats', true, 'check_coding', 2, ...
  'par_cases',0, 'prof_spec', 1, 'report_qmsr_snr', false);
