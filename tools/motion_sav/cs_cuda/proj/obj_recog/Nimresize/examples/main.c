...
static void main_Nimresize(unsigned char *uv0, const char *outf, unsigned char *outbuf  ) ;
...
static void main_Nimresize(unsigned char *uv0, char *outf, unsigned char *outbuf )
{
  ...
  if ( !file_out( outf, rout->size[0] * rout->size[1] * rout->size[2], rout->data ))
