function [U, out] = TVAL3_CVS_D3(A,b,p,q,r,opts)
%
...
%                                          s.t. D_i u = w_i
%                                               Au = b
% Here we use 3D anisotropic total variation as objective function.
%
...
for ii = 1:opts.maxit
    ...
    Up = U; gp = g; g2p = g2; Aup = Au; Uxp = Ux; Uyp = Uy; Uzp = Uz; DtsAtdp =  DtsAtd;
