classdef CS_AnlsParams < ProcessingParams
    ...
    properties
        ...
        % done in a rectangular grid centered at the optimal point (v,h) of 
        % the previous search ([0,0] in the first stage). The grid
        ...
        % In each stage the search is done m_srch_cnt times. The first
        % time after m_wait_first iterations and then each time m_wait_next
